...
import com.gokul.vegetable.Utilities.AdminHome.CartItems;
                        ...
                        holder.imageViewMinusCart.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                databaseReference.addValueEventListener(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        String value = snapshot.child("TotalQuantity").getValue(String.class);
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (mobile == null && address == null) {
                                    ...
                                    if (isAdded() && getView() != null) {
                                        Snackbar snackBar = Snackbar.make(requireView(), "Fill Address Section First..", Snackbar.LENGTH_LONG)
                                                .setAction("Yes", view1 -> {
                                    ...
                                    if (isAdded() && getView() != null) {
                                        // Log data to check if mobile and address values are not null
                                        Log.d("FirebaseData", "Mobile: " + mobile + ", Address: " + address);
